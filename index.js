...
function formSubmit(event) {
	...
	var url = `http://svcs.ebay.com/services/search/FindingService/v1?OPERATION-NAME=${filter.findBy}&SERVICE-VERSION=1.0.0&SECURITY-APPNAME=${filter.securityAppName}&GLOBAL-ID=EBAY-US&RESPONSE-DATA-FORMAT=JSON&callback=findCompletedItems&REST-PAYLOAD&keywords=${term}"card"&paginationInput.entriesPerPage=20`;
